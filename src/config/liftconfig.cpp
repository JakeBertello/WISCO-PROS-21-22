...
namespace lift_config {
    ...
    /********************************* LIFT_CONFIG *********************************/
    subsystem::Subsystem bassBooster = lift::Lift::build().withLeftMotor(&bassBoosterLeft)
                                                .withRightMotor(&bassBoosterRight);

    op_lift_controller::OpLiftController bassBoosterController(&bassBooster, &config::master);                                            


    subsystem::Subsystem normalLift = lift::Lift::build().withLeftMotor(&normalLiftLeft)
